    ...
    return (
        <div className="p-5 rounded-md shadow-xl bg-white border border-y-gray-100">
            ...
            <div>
                ...
                <p className="text-sm text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, architecto excepturi aliquam nihil dicta saepe.</p>
            </div>
