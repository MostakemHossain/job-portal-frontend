            ...
            <div className="max-w-6xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
                ...
                <div className="my-5">
                    <div className="flex items-center gap-3 my-2">
                        <Mail />
                        <span>mostakememon123@gmail.com</span>
                    </div>
                    <div className="flex items-center gap-3 my-2">
                        <Contact />
                        <span>0002i939444834</span>
                    </div>
                </div>
                <div className="my-5">
                    <h1>Skills</h1>
                ...
                <div className="grid w-full max-w-sm items-center gap-2">
                    ...
                    {
                        isHaveResume ? <a target="blank" href="/" className="text-blue-500 hover:underline font-bold">Mostakem Hossain</a> : <span>N/A</span>
                    }
